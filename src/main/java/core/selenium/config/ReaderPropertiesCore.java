 ...
 */
public final class ReaderPropertiesCore {

    private static ReaderPropertiesCore environment;
    private static final Logger LOGGER = LogManager.getLogger(ReaderPropertiesCore.class);
     ...
     */
    public ReaderPropertiesCore(final String propertiesPath) {
        try {
